/*
 ...
 Autor: Zoran Vrhovski
  ...
  Vježba 12.1.1 - cetverokvadrantni nacin rada
 */ 
...
// cetverokvadrantni nacin rada, INT0 i INT1 - rastuci i padajuci brid
ISR(INT0_vect) {
...
void inicijalizacija() {
	...
	int1_enable(); // omoguci INT1
	int1_set_rising_falling_edge(); // rastuci i padajuci brid generira prekid na INT1
